var $primary = "#00b5b8",
    ...
    barBasicChart = {
        ...
        xaxis: { categories: ["South sKorea {{general()->title}}", "Canada", "United Kingdom", "Netherlands", "Italy", "France", "Japan", "United States", "China", "Germany"] },
        fill: { colors: $themeColor },
    },
    mixedLineColumnAreaChart = {
        ...
        colors: $themeColor,
        series: [
            { name: "Facebook", type: "column", data: [23, 11, 22, 27, 13, 22, 37, 21, 44, 22, 30] },
...
var threedBubbleChart = {
        ...
        dataLabels: { enabled: !1 },
        series: [
            { name: "Product1", data: generateData(new Date("11 Feb 2017 GMT").getTime(), 20, { min: 10, max: 60 }) },
