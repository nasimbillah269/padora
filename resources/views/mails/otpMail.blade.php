...
<title>OTP Verification Mail {{general()->title}} </title>
...
<center>
    ...
    <h2 style="margin:0;">Hi {{$datas['name']}},</h2>
    <p style="margin:0;">Here is your verification code for {{general()->title}}</p>
</center>

<div style="background:#f1f1f1;padding:10px;margin: 10px 0;">
  <p style="margin:0;border-bottom:1px solid #c6c6c6;padding:5px 0;">VERIFICATION CODE</p>
  <center>
    <p style="margin:15px 0;font-size:32px;font-weight:bold;letter-spacing:8px;color:#a01a22;">{{$datas['otp']}}</p>
  </center>
  <p style="margin:0;">This code will expire in <strong>5 minutes</strong>. Please do not share this code with anyone.</p>
