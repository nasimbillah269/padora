...
<div style="background:#f1f1f1;padding:10px;margin: 10px 0;">
  ...
  <p style="margin:0;"><strong>Mobile:</strong> {{$user->mobile}}</p>
  <p style="margin:0;"><strong>Email:</strong> {{$user->email}}</p>
  <center>
  <span>Verify Code: {{$user->verify_code}} </span><br>
  <a href="{{route('resetPassword',[$user->remember_token?:'notoken','code'=>$user->verify_code])}}">Click to Reset</a>
  </center>
  <br>
