        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 form-group">
                    <label for="footer_text">Notice Scrolling Text</label>
                    <input type="text" name="footer_text" value="{{ $general->copyright_text }}" placeholder="Notice Scrolling Text" class="form-control {{$errors->has('footer_text')?'error':''}}" />
