                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($role->id==1)
                                <a href="{{route('admin.userRoleAction',['edit',$role->id])}}" class="btn btn-md btn-info">
                                ...
                                <a href="{{route('admin.userRoleAction',['delete',$role->id])}}" onclick="return confirm('Are You Want To Delete')" class="btn btn-md btn-danger">
