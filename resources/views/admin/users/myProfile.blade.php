                            ...
                            <form action="{{route('admin.myProfile')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="media">
                                    <a href="javascript: void(0);">
                                        <img src="{{route('imageView2',['profile',$user->imageName(),'w'=>100,'h'=>100])}}" class="ProfileImage image_{{$user->id}}" alt="profile image" />
                                    </a>
                                    <div class="media-body mt-75">
                                        <div class="col-12 px-0 d-flex flex-sm-row flex-column justify-content-start">
                                            <label class="btn btn-sm btn-primary ml-50 mb-50 mb-sm-0 cursor-pointer" for="account-upload">Upload new photo </label>
                                            <input type="file" name="image" class="profile-upload" id="account-upload" data-imageshow="image_{{$user->id}}" hidden="" />
