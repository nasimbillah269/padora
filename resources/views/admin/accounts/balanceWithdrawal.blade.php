...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title mb-0">Withdrawal List</h3>
    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            ...
            <a class="btn btn-outline-primary" href="{{route('admin.accountsWithdrawal')}}">
...
<div class="content-body">
                              ...
                              <div class="table-responsive">
                                  <table class="table table-bordered">
                                      ...
                                      <tr>
                                          ...
                                          <td>
                                            <button class="btn btn-sm btn-info" type="button" data-toggle="modal" data-target="#updateWithdrawal{{$deposit->id}}">
                                                   Edit
                                            </button>
                                             <!-- Modal -->
                                                 <div class="modal fade text-left" id="updateWithdrawal{{$deposit->id}}" >
                                                   <div class="modal-dialog" role="document">
                                                     <div class="modal-content">
                                                        <form action="{{route('admin.accountsWithdrawal',['update',$deposit->id])}}" method="post">
                                                            @csrf
                                                           <div class="modal-header">
                                                             <h4 class="modal-title" id="myModalLabel1">Withdrawal</h4>
                                                           ...
                                                           <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label>Amount*</label>
                                                                    <input type="number" name="amount" class="form-control" value="{{$deposit->amount}}" placeholder="0" required="">
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control" name="method" required="">
                                                                        <option value="">Select Method</option>
                                                                        @foreach($methods as $method)
                                                                        <option value="{{$method->id}}" {{$method->id==$deposit->method_id?'selected':''}}>{{$method->name}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                            ...
                                            <a href="{{route('admin.accountsWithdrawal',['delete',$deposit->id])}}" class="btn btn-sm btn-danger" onclick="return confirm('Are You Want To Delete?')"><i class="fa fa-trash"></i></a>
                                          </td>
                                      </tr>
                                      @endforeach
                                  </table>
 ...
 <div class="modal fade text-left" id="WithdrawalDeposit" >
   <div class="modal-dialog" role="document">
     <div class="modal-content">
        <form action="{{route('admin.accountsWithdrawal','create')}}" method="post">
            @csrf
           <div class="modal-header">
             <h4 class="modal-title" id="myModalLabel1">Withdrawal</h4>
             <button type="button" class="close" data-dismiss="modal" aria-label="Close">
