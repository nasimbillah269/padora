                        ...
                        <div class="card-body">
                           <div class="row">
	                           ...
	                           <div class="col-md-8">
                                    ...
                                    <tr>
                                        <th>Stock </th>
                                        <td>{{$product->quantity}} Qty : <b>Full Stock</b> {{$product->productFullStock()}} Qty</td>
                                    </tr>
                                    <tr>
                                        <th>Branch Stock </th>
                                        <td>
                                            <table class="table" style="margin:0;">
                                                @foreach($product->productBranchesStockList as $Bstock)
                                                <tr>
                                                    <td style="padding: 1px 5px;width:50%;">{{$Bstock->branch?$Bstock->branch->name:'Not Found'}}</td>
                                                    <td style="padding: 1px 5px;">{{$Bstock->stock}} Qty</td>
                                                </tr>
                                                @endforeach
                                            </table>
                                        </td>
