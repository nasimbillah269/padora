                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header" style="border-bottom: 1px solid #e3ebf3;">
                            ...
                            @if($product->slug)
                            <a href="{{route('productView',$product->slug?:'no-slug')}}" target="_blank">View</a>
                            @endif
                            </h4>
                        </div>
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-6">
                                        <label for="bestSale">Best Sale</label>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="bestSale" name="bestSale" {{$product->bestSale?'checked':''}}/>
                                            <label class="custom-control-label" for="bestSale">Active</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
    ...
    $(document).ready(function(){
        ...
        ///Product Price Jquery
            ...
            $(document).on('change keyup mouseup','.priceUpdate',function(){
              ...
              $('.final_price').val(final_price.toFixed(0));
