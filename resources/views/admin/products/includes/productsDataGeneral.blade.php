...
<div class="row">
	...
	<div class="form-group col-md-4">
		<label>Weight Per Pices</label>
		<input type="text" name="weight_per_pices" 
		value="{{$product->weight_per_pices?$product->weight_per_pices:old('weight_per_pices')}}" 
		data-url="{{route('admin.productsUpdateAjax',['weight_per_pices',$product->id])}}" 
	    class="form-control productDataAjaxUpdate form-control-sm {{$errors->has('weight_per_pices')?'error':''}}"
			placeholder="weight per pices">

	</div>

	<!--<div class="form-group col-md-4">-->
	<!--	<label>Weight KG Per/Quantity</label>-->
	<!--	<input type="number" name="weight_per_quantity" -->
	<!--	value="{{$product->weight_per_quantity?$product->weight_per_quantity:old('weight_per_quantity')}}" -->
	<!--	data-url="{{route('admin.productsUpdateAjax',['weight_per_quantity',$product->id])}}" -->
	<!--    class="form-control productDataAjaxUpdate form-control-sm {{$errors->has('weight_per_quantity')?'error':''}}"-->
	<!--		placeholder="weight kg per Quantity">-->
	<!--</div>-->
	<div class="form-group col-md-4">
		<label>Ice KG Per/Quantity</label>
		<input type="number" name="weight_per_ices" 
		value="{{$product->weight_per_ices?$product->weight_per_ices:old('weight_per_ices')}}" 
		data-url="{{route('admin.productsUpdateAjax',['weight_per_ices',$product->id])}}" 
	    class="form-control productDataAjaxUpdate form-control-sm {{$errors->has('weight_per_ices')?'error':''}}"
			placeholder="weight per Ice KG">
