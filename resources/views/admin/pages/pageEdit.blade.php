                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="template">
                                        ...
                                        <option value="Single Page" {{$page->template=='Single Page'?'selected':''}}>Single Page</option>
                                        <option value="My Account" {{$page->template=='My Account'?'selected':''}}>My Account</option>
                                    </select>
