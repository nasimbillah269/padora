...
<div class="content-header row">
    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            <a class="btn btn-outline-primary" href="{{route('admin.postsCategories')}}">BACK</a>
		    <a class="btn btn-outline-primary" href="{{route('admin.postsCategoriesAction',['create'])}}">Add Category</a>
            <a class="btn btn-outline-primary" href="{{route('admin.postsCategoriesAction',['edit',$category->id])}}">
